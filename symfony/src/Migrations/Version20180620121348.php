 ...
 */
final class Version20180620121348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rooms CHANGE name name VARCHAR(50) NOT NULL, CHANGE adress adress VARCHAR(50) NOT NULL, CHANGE city city VARCHAR(50) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE is_rented is_rented TINYINT(1) DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE users ADD location VARCHAR(40) NOT NULL, DROP phone, DROP bankData, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(64) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rooms CHANGE name name VARCHAR(120) NOT NULL COLLATE utf8_unicode_ci, CHANGE adress adress VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE city city VARCHAR(60) NOT NULL COLLATE utf8_unicode_ci, CHANGE description description VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, CHANGE is_rented is_rented TINYINT(1) NOT NULL');
        $this->addSql('DROP INDEX UNIQ_1483A5E9E7927C74 ON users');
        $this->addSql('ALTER TABLE users ADD phone VARCHAR(10) DEFAULT NULL COLLATE utf8_unicode_ci, ADD bankData VARCHAR(50) DEFAULT NULL COLLATE utf8_unicode_ci, DROP location, CHANGE email email VARCHAR(120) NOT NULL COLLATE utf8_unicode_ci, CHANGE password password VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
