 ...
 */
final class Version20180621080004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rooms ADD description VARCHAR(255) NOT NULL, ADD is_rented TINYINT(1) DEFAULT \'0\' NOT NULL, DROP user_id, DROP dispo, DROP date_dispo, CHANGE name name VARCHAR(50) NOT NULL, CHANGE adress adress VARCHAR(50) NOT NULL, CHANGE city city VARCHAR(50) NOT NULL, CHANGE postal_code postal_code VARCHAR(10) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rooms ADD user_id INT DEFAULT NULL, ADD dispo TINYINT(1) NOT NULL, ADD date_dispo DATETIME DEFAULT NULL, DROP description, DROP is_rented, CHANGE name name VARCHAR(120) NOT NULL COLLATE utf8_unicode_ci, CHANGE adress adress VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE city city VARCHAR(60) NOT NULL COLLATE utf8_unicode_ci, CHANGE postal_code postal_code VARCHAR(5) NOT NULL COLLATE utf8_unicode_ci');
